...
abstract class KubeConfigUpdate private constructor(
    ...
    class UpdateToken(
        ...
        override fun apply() {
            val username = context.context.user
    ...
    class CreateContext(
        ...
        private fun createUser(allConfigs: List<KubeConfig>): KubeConfigNamedUser {
            ...
            val uniqueUserName = createUniqueName(clusterName, existingUserNames)
        ...
        private fun createCluster(allConfigs: List<KubeConfig>): KubeConfigNamedCluster {
            ...
            val uniqueClusterName = createUniqueName(clusterName, existingClusterNames)
        ...
        private fun createContext(
            ...
            val uniqueContextName = createUniqueName(tempContext.name, existingContextNames)
        ...
        private fun createUniqueName(baseName: String, existingNames: Set<String>): String {
